...
CREATE TABLE `members` (
  `member_id` varchar(20) PRIMARY KEY COMMENT 'Format: KNAA-YYYY-XXXXX',
...
CREATE TABLE `full_membership_details` (
  ...
  `member_id` varchar(20) COMMENT 'One-to-one relationship',
...
CREATE TABLE `event_registrations` (
  ...
  `event_id` int,
  `member_id` varchar(20) COMMENT 'NULL if non-member',
  `first_name` varchar(100) NOT NULL,
  `last_name` varchar(100) NOT NULL,
...
CREATE TABLE `email_logs` (
  ...
  `member_id` varchar(20) COMMENT 'NULL for non-member emails',
...
INSERT INTO membership_types (type_id, type_name, annual_fee, is_active) 
VALUES 
(1, 'Full', 0.00, true),
(2, 'Student', 0.00, true);
